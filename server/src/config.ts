...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'kesolimpico';
    ...
    'jhipster.mail.from' = 'kesolimpico@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'kesolimpico API';
    'jhipster.swagger.description' = 'kesolimpico API documentation';
    ...
    'eureka.instance.appname' = 'kesolimpico';
    'eureka.instance.instanceId' = 'kesolimpico:${random.value}';
