...
describe('Component Tests', () => {
  describe('Recepcion Management Component', () => {
    let comp: RecepcionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RecepcionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.recepcions?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
